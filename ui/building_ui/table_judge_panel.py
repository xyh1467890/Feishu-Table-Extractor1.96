...
from building_spec.table_judge import TableSingleJudge


class TableJudgePanel(QWidget):
    """Table 评测面板"""
    ...
    def __init__(self, parent=None):
        ...
        self.table_single_judge = TableSingleJudge()
        self.init_ui()
    ...
    def _create_single_test_section(self):
        ...
        # Before Base Token 和 Base Tokens 在同一行
    ...
    def on_single_test(self):
        ...
        # 发送请求
        result = self.table_single_judge.send_request(
            queries=queries,
