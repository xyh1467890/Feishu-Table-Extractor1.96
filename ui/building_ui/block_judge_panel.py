...
from building_spec.block_judge import BlockSingleJudge


class BlockJudgePanel(QWidget):
    """Block 评测面板"""
    ...
    def __init__(self, parent=None):
        ...
        self.block_single_judge = BlockSingleJudge()
        self.init_ui()
    ...
    def on_single_test(self):
        ...
        # 发送请求
        result = self.block_single_judge.send_request(
            queries=queries,
